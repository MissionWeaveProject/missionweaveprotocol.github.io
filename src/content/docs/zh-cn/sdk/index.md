...
| -------------------------------------------------------------------- | ------------ | -------- | ----------------------- | -------------- |
| [Python](https://github.com/missionweaveprotocol/python-sdk)         | 完整参考实现 | 是       | 56/56 个向量            | 是             |
| [Go](https://github.com/missionweaveprotocol/go-sdk)                 | 官方协议 SDK | 是       | 56/56 个向量            | 否             |
| [TypeScript](https://github.com/missionweaveprotocol/typescript-sdk) | 官方协议 SDK | 是       | 56/56 个向量            | 否             |
| [Java](https://github.com/missionweaveprotocol/java-sdk)             | 官方协议 SDK | 是       | 56/56 个向量            | 否             |
| [Rust](https://github.com/missionweaveprotocol/rust-sdk)             | 官方协议 SDK | 是       | 56/56 个向量            | 否             |
| [C++](https://github.com/missionweaveprotocol/cpp-sdk)               | 官方协议 SDK | 是       | 56/56 个向量            | 否             |

Schema 与测试向量符合性涵盖严格 JSON 处理、对固定的 21 个 Draft 2020-12
Schema 进行离线验证、规范 JSON 与内容 ID、Ed25519 签名、Frame 验证，以及固定的 56 个符合性测试向量。仅通过这些测试并不能证明调度、持久化、恢复、传输或其他运行时行为的符合性。
