...
| -------------------------------------------------------------------- | ------------ | -------- | ----------------------- | ---------------- |
| [Python](https://github.com/missionweaveprotocol/python-sdk)         | 完整參考實作 | 是       | 56/56 個向量            | 是               |
| [Go](https://github.com/missionweaveprotocol/go-sdk)                 | 官方協定 SDK | 是       | 56/56 個向量            | 否               |
| [TypeScript](https://github.com/missionweaveprotocol/typescript-sdk) | 官方協定 SDK | 是       | 56/56 個向量            | 否               |
| [Java](https://github.com/missionweaveprotocol/java-sdk)             | 官方協定 SDK | 是       | 56/56 個向量            | 否               |
| [Rust](https://github.com/missionweaveprotocol/rust-sdk)             | 官方協定 SDK | 是       | 56/56 個向量            | 否               |
| [C++](https://github.com/missionweaveprotocol/cpp-sdk)               | 官方協定 SDK | 是       | 56/56 個向量            | 否               |

Schema 與測試向量符合性涵蓋嚴格 JSON 處理、對固定的 21 個 Draft 2020-12
Schema 進行離線驗證、規範 JSON 與內容 ID、Ed25519 簽章、Frame 驗證，以及固定的 56 個符合性測試向量。僅通過這些測試並不能證明排程、持久化、復原、傳輸或其他 runtime 行為的符合性。
